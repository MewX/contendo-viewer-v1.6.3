...
/*    */   extends b
/*    */ {
/* 24 */   public static final j a = (j)new E();
/*    */   
...
/* 72 */         value = lu.getIntegerValue();
/* 73 */         lu = lu.getNextLexicalUnit();
/*    */       } else {
/* 75 */         value = 0;
/*    */       } 
/* 77 */       values.add(new o(ident, value));
/*    */     } 
/* 79 */     if (values.isEmpty()) {
/* 80 */       return (ad)H.a;
/*    */     }
/*    */     
/* 83 */     ae fvalues = new ae(values.<ad>toArray(new ad[values.size()]));
/* 84 */     return (ad)fvalues;
/*    */   }
/*    */ }
