...
final class FactoryFinder {
  ...
  static Object a(String paramString, ClassLoader paramClassLoader, boolean paramBoolean) throws ConfigurationError {
    try {
      Class clazz;
      if (paramClassLoader == null) {
        ...
        try {
          ...
          if (paramBoolean) {
            paramClassLoader = ((a == null) ? (a = a("javax.xml.transform.FactoryFinder")) : a).getClassLoader();
            if (paramClassLoader != null) {
              clazz = paramClassLoader.loadClass(paramString);
            } else {
              clazz = Class.forName(paramString);
  ...
  static Object a(String paramString1, String paramString2) throws ConfigurationError {
    ...
    if (classLoader == null)
      classLoader = ((a == null) ? (a = a("javax.xml.transform.FactoryFinder")) : a).getClassLoader(); 
    if (b)
    ...
    try {
      ...
      if (str3 != null) {
        if (b)
          b("found in $java.home/jaxp.properties, value=" + str3); 
        return a(str3, classLoader, true);
      } 
    } catch (Exception exception) {
      if (b)
    ...
    return a(paramString2, classLoader, true);
  }
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/javax/xml/transform/FactoryFinder.class
