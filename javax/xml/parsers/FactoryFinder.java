...
final class FactoryFinder {
    ...
    try {
      ...
      if (paramClassLoader == null) {
        ...
        try {
          ...
          if (paramBoolean) {
            paramClassLoader = ((a == null) ? (a = a("javax.xml.parsers.FactoryFinder")) : a).getClassLoader();
            if (paramClassLoader != null) {
              clazz = paramClassLoader.loadClass(paramString);
            } else {
              clazz = Class.forName(paramString);
  ...
  static Object a(String paramString1, String paramString2) throws ConfigurationError {
    ...
    if (classLoader == null)
      classLoader = ((a == null) ? (a = a("javax.xml.parsers.FactoryFinder")) : a).getClassLoader(); 
    if (b)
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/javax/xml/parsers/FactoryFinder.class
