...
/* 308 */       Validate.isTrue((name != null), "The name must not be null", new Object[0]);
/* 309 */       this.name = name;
/*     */     }
/*     */ 
/*     */     
...
/*     */     Thread[] threads;
/* 393 */     Validate.isTrue((group != null), "The group must not be null", new Object[0]);
/* 394 */     Validate.isTrue((predicate != null), "The predicate must not be null", new Object[0]);
/*     */     
...
/* 425 */     Validate.isTrue((group != null), "The group must not be null", new Object[0]);
/* 426 */     Validate.isTrue((predicate != null), "The predicate must not be null", new Object[0]);
/*     */     
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/commons/lang3/ThreadUtils.class
