...
/* 177 */     Validate.isTrue((endInclusive >= startInclusive), "Start value must be smaller or equal to end value.", new Object[0]);
/*     */     
/* 179 */     Validate.isTrue((startInclusive >= 0.0D), "Both range values must be non-negative.", new Object[0]);
/*     */     
/* 181 */     if (startInclusive == endInclusive) {
/* 182 */       return startInclusive;
/*     */     }
/*     */     
/* 185 */     return startInclusive + (endInclusive - startInclusive) * RANDOM.nextDouble();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 214 */     Validate.isTrue((endInclusive >= startInclusive), "Start value must be smaller or equal to end value.", new Object[0]);
/*     */     
/* 216 */     Validate.isTrue((startInclusive >= 0.0F), "Both range values must be non-negative.", new Object[0]);
/*     */     
/* 218 */     if (startInclusive == endInclusive) {
/* 219 */       return startInclusive;
/*     */     }
/*     */     
/* 222 */     return startInclusive + (endInclusive - startInclusive) * RANDOM.nextFloat();
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/commons/lang3/RandomUtils.class
