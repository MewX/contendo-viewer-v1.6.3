...
/*      */ 
/*      */   
/*  168 */   private static final ThreadLocal<WeakHashMap<Object, Object>> REGISTRY = new ThreadLocal<>();
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  204 */     Map<Object, Object> m = getRegistry();
...
/*  218 */     if (value != null) {
/*  219 */       Map<Object, Object> m = getRegistry();
/*  220 */       if (m == null) {
...
/*  240 */     if (value != null) {
/*  241 */       Map<Object, Object> m = getRegistry();
/*  242 */       if (m != null) {
/*  243 */         m.remove(value);
/*  244 */         if (m.isEmpty()) {
/*  245 */           REGISTRY.remove();
...
/*  389 */       int pos1 = toString.indexOf(this.contentStart) + this.contentStart.length();
/*  390 */       int pos2 = toString.lastIndexOf(this.contentEnd);
...
/* 2297 */       setFieldSeparator(System.lineSeparator() + "  ");
/* 2298 */       setFieldSeparatorAtStart(true);
/* 2299 */       setContentEnd(System.lineSeparator() + "]");
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*      */         return;
/*      */       } 
/* 2585 */       String valueAsString = value.toString();
...
/* 2595 */       return (valueAsString.startsWith(getArrayStart()) && valueAsString
/* 2596 */         .endsWith(getArrayEnd()));
/*      */     }
/*      */     
/*      */     private boolean isJsonObject(String valueAsString) {
/* 2600 */       return (valueAsString.startsWith(getContentStart()) && valueAsString
/* 2601 */         .endsWith(getContentEnd()));
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 2618 */         throw new UnsupportedOperationException("Field names are mandatory when using JsonToStringStyle");
/*      */       }
/*      */ 
/*      */       
/* 2622 */       super.appendFieldStart(buffer, "\"" + StringEscapeUtils.escapeJson(fieldName) + "\"");
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/commons/lang3/builder/ToStringStyle.class
