...
/*     */     }
/*  54 */     this._data = new int[initialCapacity];
/*  55 */     this._size = 0;
/*     */   }
/*     */ 
/*     */ 
...
/*  98 */     checkRange(index);
/*  99 */     incrModCount();
/* 100 */     int oldval = this._data[index];
...
/* 124 */     incrModCount();
/* 125 */     int oldval = this._data[index];
...
/* 172 */       int[] olddata = this._data;
/* 173 */       this._data = new int[(newcap < mincap) ? mincap : newcap];
...
/* 185 */       int[] olddata = this._data;
/* 186 */       this._data = new int[this._size];
...
/* 198 */       out.writeInt(this._data[i]);
/*     */     }
/*     */   }
/*     */   
/*     */   private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
/* 203 */     in.defaultReadObject();
/* 204 */     this._data = new int[in.readInt()];
/* 205 */     for (int i = 0; i < this._size; i++) {
/* 206 */       this._data[i] = in.readInt();
/*     */     }
/*     */   }
/*     */   
...
/*     */ 
/*     */   
/* 225 */   private transient int[] _data = null;
/* 226 */   private int _size = 0;
/*     */ }


/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/commons/collections/primitives/ArrayIntList.class
