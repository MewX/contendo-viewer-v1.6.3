...
/*     */   implements Serializable, DoubleList
/*     */ {
...
/*     */     }
/*  54 */     this._data = new double[initialCapacity];
/*  55 */     this._size = 0;
/*     */   }
/*     */ 
/*     */ 
...
/*  98 */     checkRange(index);
/*  99 */     incrModCount();
/* 100 */     double oldval = this._data[index];
...
/* 124 */     incrModCount();
/* 125 */     double oldval = this._data[index];
...
/* 172 */       double[] olddata = this._data;
/* 173 */       this._data = new double[(newcap < mincap) ? mincap : newcap];
...
/* 185 */       double[] olddata = this._data;
/* 186 */       this._data = new double[this._size];
...
/* 198 */       out.writeDouble(this._data[i]);
/*     */     }
/*     */   }
/*     */   
/*     */   private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
/* 203 */     in.defaultReadObject();
/* 204 */     this._data = new double[in.readInt()];
/* 205 */     for (int i = 0; i < this._size; i++) {
/* 206 */       this._data[i] = in.readDouble();
/*     */     }
/*     */   }
/*     */   
...
/*     */ 
/*     */   
/* 225 */   private transient double[] _data = null;
/* 226 */   private int _size = 0;
/*     */ }


/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/commons/collections/primitives/ArrayDoubleList.class
