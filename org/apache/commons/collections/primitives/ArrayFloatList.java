...
/*     */   implements Serializable, FloatList
/*     */ {
...
/*     */     }
/*  54 */     this._data = new float[initialCapacity];
/*  55 */     this._size = 0;
/*     */   }
/*     */ 
/*     */ 
...
/*  98 */     checkRange(index);
/*  99 */     incrModCount();
/* 100 */     float oldval = this._data[index];
...
/* 124 */     incrModCount();
/* 125 */     float oldval = this._data[index];
...
/* 172 */       float[] olddata = this._data;
/* 173 */       this._data = new float[(newcap < mincap) ? mincap : newcap];
...
/* 185 */       float[] olddata = this._data;
/* 186 */       this._data = new float[this._size];
...
/* 198 */       out.writeFloat(this._data[i]);
/*     */     }
/*     */   }
/*     */   
/*     */   private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
/* 203 */     in.defaultReadObject();
/* 204 */     this._data = new float[in.readInt()];
/* 205 */     for (int i = 0; i < this._size; i++) {
/* 206 */       this._data[i] = in.readFloat();
/*     */     }
/*     */   }
/*     */   
...
/*     */ 
/*     */   
/* 225 */   private transient float[] _data = null;
/* 226 */   private int _size = 0;
/*     */ }


/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/commons/collections/primitives/ArrayFloatList.class
