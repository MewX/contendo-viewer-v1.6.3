...
/*     */   implements Serializable, CharList
/*     */ {
...
/*     */     }
/*  54 */     this._data = new char[initialCapacity];
/*  55 */     this._size = 0;
/*     */   }
/*     */ 
/*     */ 
...
/*  98 */     checkRange(index);
/*  99 */     incrModCount();
/* 100 */     char oldval = this._data[index];
...
/* 124 */     incrModCount();
/* 125 */     char oldval = this._data[index];
...
/* 172 */       char[] olddata = this._data;
/* 173 */       this._data = new char[(newcap < mincap) ? mincap : newcap];
...
/* 185 */       char[] olddata = this._data;
/* 186 */       this._data = new char[this._size];
...
/* 198 */       out.writeChar(this._data[i]);
/*     */     }
/*     */   }
/*     */   
/*     */   private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException {
/* 203 */     in.defaultReadObject();
/* 204 */     this._data = new char[in.readInt()];
/* 205 */     for (int i = 0; i < this._size; i++) {
/* 206 */       this._data[i] = in.readChar();
/*     */     }
/*     */   }
/*     */   
...
/*     */ 
/*     */   
/* 225 */   private transient char[] _data = null;
/* 226 */   private int _size = 0;
/*     */ }


/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/commons/collections/primitives/ArrayCharList.class
