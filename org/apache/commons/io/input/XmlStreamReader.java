...
/* 137 */     this(new FileInputStream(file));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 183 */     this(is, lenient, (String)null);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 271 */       this.encoding = doHttpStream(bom, pis, contentType, true);
/*     */     } else {
/* 273 */       this.encoding = doRawStream(bom, pis, true);
/*     */     } 
...
/*     */       try {
/* 482 */         return calculateHttpEncoding(httpContentType, ex.getBomEncoding(), ex
/* 483 */             .getXmlGuessEncoding(), ex.getXmlEncoding(), true);
...
/*     */       }
/* 515 */       if (xmlEnc.equals("UTF-16") && (xmlGuessEnc
/* 516 */         .equals("UTF-16BE") || xmlGuessEnc.equals("UTF-16LE"))) {
...
/* 760 */     return (mime != null && (mime
/* 761 */       .equals("application/xml") || mime
/* 762 */       .equals("application/xml-dtd") || mime
/* 763 */       .equals("application/xml-external-parsed-entity") || (mime
/* 764 */       .startsWith("application/") && mime.endsWith("+xml"))));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 775 */     return (mime != null && (mime
/* 776 */       .equals("text/xml") || mime
/* 777 */       .equals("text/xml-external-parsed-entity") || (mime
/* 778 */       .startsWith("text/") && mime.endsWith("+xml"))));
/*     */   }
/*     */ }


/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/commons/io/input/XmlStreamReader.class
