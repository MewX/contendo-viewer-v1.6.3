...
/*  288 */     else if (contains(value, index, 2, new String[] { "CZ"
/*  289 */         }) && !contains(value, index - 2, 4, new String[] { "WICZ" }))
/*      */     
...
/*  295 */     { result.append('X');
/*  296 */       index += 3; }
/*  297 */     else { if (contains(value, index, 2, new String[] { "CC" }) && (index != 1 || 
/*  298 */         charAt(value, 0) != 'M'))
/*      */       {
...
/*      */           
/*  316 */           index += 3;
/*  317 */         } else if (contains(value, index + 1, 1, new String[] { "C", "K", "Q"
/*  318 */             }) && !contains(value, index + 1, 2, new String[] { "CE", "CI" })) {
/*  319 */           index += 2;
/*      */         } else {
/*  321 */           index++;
/*      */         } 
...
/*  332 */     if (contains(value, index + 2, 1, new String[] { "I", "E", "H"
/*  333 */         }) && !contains(value, index + 2, 2, new String[] { "HU" })) {
/*      */       
/*  335 */       if ((index == 1 && charAt(value, index - 1) == 'A') || 
/*  336 */         contains(value, index - 1, 5, new String[] { "UCCEE", "UCCES" })) {
/*      */         
...
/*  415 */       } else if (!contains(value, index + 2, 2, new String[] { "EY"
...
/*  430 */       index += 2;
/*  431 */     } else if ((contains(value, index + 1, 2, new String[] { "ER"
/*  432 */         }) || charAt(value, index + 1) == 'Y') && 
/*  433 */       !contains(value, 0, 6, new String[] { "DANGER", "RANGER", "MANGER"
/*  434 */         }) && !contains(value, index - 1, 1, new String[] { "E", "I"
/*  435 */         }) && !contains(value, index - 1, 3, new String[] { "RGY", "OGY" })) {
/*      */       
/*  437 */       result.append('K', 'J');
/*  438 */       index += 2;
/*  439 */     } else if (contains(value, index + 1, 1, new String[] { "E", "I", "Y"
/*  440 */         }) || contains(value, index - 1, 4, new String[] { "AGGI", "OGGI" })) {
/*      */       
/*  442 */       if (contains(value, 0, 4, new String[] { "VAN ", "VON "
/*  443 */           }) || contains(value, 0, 3, new String[] { "SCH"
/*  444 */           }) || contains(value, index + 1, 2, new String[] { "ET" })) {
/*      */         
/*  446 */         result.append('K');
...
/*      */       } 
/*  476 */       index += 2;
/*  477 */     } else if ((index > 1 && contains(value, index - 2, 1, new String[] { "B", "H", "D" })) || (index > 2 && 
/*  478 */       contains(value, index - 3, 1, new String[] { "B", "H", "D" })) || (index > 3 && 
/*  479 */       contains(value, index - 4, 1, new String[] { "B", "H" }))) {
/*      */       
/*  481 */       index += 2;
/*      */     } else {
/*  483 */       if (index > 2 && charAt(value, index - 1) == 'U' && 
/*  484 */         contains(value, index - 3, 1, new String[] { "C", "G", "L", "R", "T" })) {
/*      */         
/*  486 */         result.append('F');
...
/*      */       
/*  518 */       if ((index == 0 && charAt(value, index + 4) == ' ') || value
/*  519 */         .length() == 4 || contains(value, 0, 4, new String[] { "SAN " })) {
/*  520 */         result.append('H');
/*      */       } else {
...
/*  534 */         !contains(value, index - 1, 1, new String[] { "S", "K", "L" })) {
/*  535 */         result.append('J');
/*      */       } 
/*      */       
...
/*  585 */       contains(value, index - 2, 2, new String[] { "IE"
/*  586 */         }) && !contains(value, index - 4, 2, new String[] { "ME", "MA" })) {
...
/*      */       } 
/*  621 */       index += 3;
/*  622 */     } else if ((index == 0 && contains(value, index + 1, 1, new String[] { "M", "N", "L", "W"
/*  623 */         })) || contains(value, index + 1, 1, new String[] { "Z" })) {
/*      */ 
/*      */ 
/*      */ 
/*      */       
...
/*  684 */       if (contains(value, index + 2, 2, new String[] { "OM", "AM"
/*      */           
/*  686 */           }) || contains(value, 0, 4, new String[] { "VAN ", "VON "
/*  687 */           }) || contains(value, 0, 3, new String[] { "SCH" })) {
/*  688 */         result.append('T');
/*      */       } else {
...
/*  707 */       index += 2;
/*      */     }
/*  709 */     else if (index == 0 && (isVowel(charAt(value, index + 1)) || 
/*  710 */       contains(value, index, 2, new String[] { "WH" }))) {
...
/*  720 */       contains(value, index - 1, 5, new String[] { "EWSKI", "EWSKY", "OWSKI", "OWSKY"
/*  721 */         }) || contains(value, 0, 3, new String[] { "SCH" })) {
/*      */       
...
/*  745 */         !contains(value, index - 3, 3, new String[] { "IAU", "EAU"
/*  746 */           }) && !contains(value, index - 2, 2, new String[] { "AU", "OU" })))
/*      */       {
...
/*  763 */       index += 2;
/*      */     } else {
/*  765 */       if (contains(value, index + 1, 2, new String[] { "ZO", "ZI", "ZA" }) || (slavoGermanic && index > 0 && 
/*  766 */         charAt(value, index - 1) != 'T')) {
...
/*  792 */     return ((c != 'I' && c != 'E') || 
/*  793 */       contains(value, index - 2, 6, new String[] { "BACHER", "MACHER" }));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  801 */     if (index != 0)
/*  802 */       return false; 
/*  803 */     if (!contains(value, index + 1, 5, new String[] { "HARAC", "HARIS"
/*  804 */         }) && !contains(value, index + 1, 3, new String[] { "HOR", "HYM", "HIA", "HEM" }))
/*  805 */       return false; 
...
/*  817 */     return (contains(value, 0, 4, new String[] { "VAN ", "VON " }) || contains(value, 0, 3, new String[] { "SCH"
/*  818 */         }) || contains(value, index - 2, 6, new String[] { "ORCHES", "ARCHIT", "ORCHID"
/*  819 */         }) || contains(value, index + 2, 1, new String[] { "T", "S"
/*  820 */         }) || ((contains(value, index - 1, 1, new String[] { "A", "O", "U", "E" }) || index == 0) && (
...
/*  829 */       contains(value, index - 1, 4, new String[] { "ILLO", "ILLA", "ALLE" }))
/*  830 */       return true; 
/*  831 */     if ((contains(value, value.length() - 2, 2, new String[] { "AS", "OS"
/*  832 */         }) || contains(value, value.length() - 1, 1, new String[] { "A", "O"
/*  833 */         })) && contains(value, index - 1, 4, new String[] { "ALLE" })) {
/*  834 */       return true;
/*      */     }
/*  836 */     return false;
/*      */   }
...
/*  845 */       return true;
/*      */     }
/*  847 */     return (contains(value, index - 1, 3, new String[] { "UMB" }) && (index + 1 == value
/*  848 */       .length() - 1 || contains(value, index + 2, 2, new String[] { "ER" })));
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  858 */     return (value.indexOf('W') > -1 || value.indexOf('K') > -1 || value
/*  859 */       .indexOf("CZ") > -1 || value.indexOf("WITZ") > -1);
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/commons/codec/language/DoubleMetaphone.class
