...
public abstract class AbstractSAXParser extends AbstractXMLDocumentParser implements PSVIProvider, Parser, XMLReader {
  ...
  public void startExternalSubset(XMLResourceIdentifier paramXMLResourceIdentifier, Augmentations paramAugmentations) throws XNIException {
    startParameterEntity("[dtd]", (XMLResourceIdentifier)null, (String)null, paramAugmentations);
  }
  ...
  protected static final class AttributesProxy implements AttributeList, Attributes2 {
    ...
    public String getType(String param1String1, String param1String2) {
      return (param1String1.length() == 0) ? this.fAttributes.getType(null, param1String2) : this.fAttributes.getType(param1String1, param1String2);
    }
    ...
    public String getValue(String param1String1, String param1String2) {
      return (param1String1.length() == 0) ? this.fAttributes.getValue(null, param1String2) : this.fAttributes.getValue(param1String1, param1String2);
    }
    ...
    public int getIndex(String param1String1, String param1String2) {
      return (param1String1.length() == 0) ? this.fAttributes.getIndex(null, param1String2) : this.fAttributes.getIndex(param1String1, param1String2);
    }
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/xerces/parsers/AbstractSAXParser.class
