...
class DurationImpl extends Duration implements Serializable {
  ...
  private static BigInteger wrap(int paramInt) {
    return (paramInt == Integer.MIN_VALUE) ? null : BigInteger.valueOf(paramInt);
  }
  ...
  public int compare(Duration paramDuration) {
    ...
    BigInteger bigInteger2 = (BigInteger)paramDuration.getField(DatatypeConstants.YEARS);
    if (bigInteger2 != null && bigInteger2.compareTo(bigInteger1) == 1)
      throw new UnsupportedOperationException(DatatypeMessageFormatter.formatMessage(null, "TooLarge", new Object[] { getClass().getName() + "#compare(Duration duration)" + DatatypeConstants.YEARS.toString(), bigInteger2.toString() })); 
    BigInteger bigInteger3 = (BigInteger)paramDuration.getField(DatatypeConstants.MONTHS);
    if (bigInteger3 != null && bigInteger3.compareTo(bigInteger1) == 1)
      throw new UnsupportedOperationException(DatatypeMessageFormatter.formatMessage(null, "TooLarge", new Object[] { getClass().getName() + "#compare(Duration duration)" + DatatypeConstants.MONTHS.toString(), bigInteger3.toString() })); 
    BigInteger bigInteger4 = (BigInteger)paramDuration.getField(DatatypeConstants.DAYS);
    if (bigInteger4 != null && bigInteger4.compareTo(bigInteger1) == 1)
      throw new UnsupportedOperationException(DatatypeMessageFormatter.formatMessage(null, "TooLarge", new Object[] { getClass().getName() + "#compare(Duration duration)" + DatatypeConstants.DAYS.toString(), bigInteger4.toString() })); 
    BigInteger bigInteger5 = (BigInteger)paramDuration.getField(DatatypeConstants.HOURS);
    if (bigInteger5 != null && bigInteger5.compareTo(bigInteger1) == 1)
      throw new UnsupportedOperationException(DatatypeMessageFormatter.formatMessage(null, "TooLarge", new Object[] { getClass().getName() + "#compare(Duration duration)" + DatatypeConstants.HOURS.toString(), bigInteger5.toString() })); 
    BigInteger bigInteger6 = (BigInteger)paramDuration.getField(DatatypeConstants.MINUTES);
    if (bigInteger6 != null && bigInteger6.compareTo(bigInteger1) == 1)
      throw new UnsupportedOperationException(DatatypeMessageFormatter.formatMessage(null, "TooLarge", new Object[] { getClass().getName() + "#compare(Duration duration)" + DatatypeConstants.MINUTES.toString(), bigInteger6.toString() })); 
    ...
    if (bigInteger7 != null && bigInteger7.compareTo(bigInteger1) == 1)
      throw new UnsupportedOperationException(DatatypeMessageFormatter.formatMessage(null, "TooLarge", new Object[] { getClass().getName() + "#compare(Duration duration)" + DatatypeConstants.SECONDS.toString(), bigInteger7.toString() })); 
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/xerces/jaxp/datatype/DurationImpl.class
