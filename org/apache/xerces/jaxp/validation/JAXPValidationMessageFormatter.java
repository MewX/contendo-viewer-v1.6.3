...
final class JAXPValidationMessageFormatter {
  public static String formatMessage(Locale paramLocale, String paramString, Object[] paramArrayOfObject) throws MissingResourceException {
    ...
    ResourceBundle resourceBundle = ResourceBundle.getBundle("org.apache.xerces.impl.msg.JAXPValidationMessages", paramLocale);
    try {
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/xerces/jaxp/validation/JAXPValidationMessageFormatter.class
