...
public class SchemaGrammar implements XSGrammar, XSNamespaceItem {
  ...
  public SchemaGrammar(SchemaGrammar paramSchemaGrammar) {
    ...
    if (paramSchemaGrammar.fLocations != null)
      for (byte b = 0; b < paramSchemaGrammar.fLocations.size(); b++)
        addDocument(null, paramSchemaGrammar.fLocations.elementAt(b));  
  }
  ...
  public final void addIDConstraintDecl(XSElementDecl paramXSElementDecl, IdentityConstraint paramIdentityConstraint, String paramString) {
    this.fGlobalIDConstraintDeclsExt.put(((paramString != null) ? paramString : "") + "," + paramIdentityConstraint.getIdentityConstraintName(), paramIdentityConstraint);
  }
  ...
  public final XSAttributeDecl getGlobalAttributeDecl(String paramString1, String paramString2) {
    return (XSAttributeDecl)this.fGlobalAttrDeclsExt.get(((paramString2 != null) ? paramString2 : "") + "," + paramString1);
  }
  ...
  public final XSAttributeGroupDecl getGlobalAttributeGroupDecl(String paramString1, String paramString2) {
    return (XSAttributeGroupDecl)this.fGlobalAttrGrpDeclsExt.get(((paramString2 != null) ? paramString2 : "") + "," + paramString1);
  }
  ...
  public final XSElementDecl getGlobalElementDecl(String paramString1, String paramString2) {
    return (XSElementDecl)this.fGlobalElemDeclsExt.get(((paramString2 != null) ? paramString2 : "") + "," + paramString1);
  }
  ...
  public final XSGroupDecl getGlobalGroupDecl(String paramString1, String paramString2) {
    return (XSGroupDecl)this.fGlobalGroupDeclsExt.get(((paramString2 != null) ? paramString2 : "") + "," + paramString1);
  }
  ...
  public final XSNotationDecl getGlobalNotationDecl(String paramString1, String paramString2) {
    return (XSNotationDecl)this.fGlobalNotationDeclsExt.get(((paramString2 != null) ? paramString2 : "") + "," + paramString1);
  }
  ...
  public final XSTypeDefinition getGlobalTypeDecl(String paramString1, String paramString2) {
    return (XSTypeDefinition)this.fGlobalTypeDeclsExt.get(((paramString2 != null) ? paramString2 : "") + "," + paramString1);
  }
  ...
  public final IdentityConstraint getIDConstraintDecl(String paramString1, String paramString2) {
    return (IdentityConstraint)this.fGlobalIDConstraintDeclsExt.get(((paramString2 != null) ? paramString2 : "") + "," + paramString1);
  }
  ...
  public static SchemaGrammar getS4SGrammar(short paramShort) {
    return (paramShort == 1) ? SG_SchemaNS : SG_SchemaNSExtended;
  }
  ...
  public synchronized XSNamedMap getComponents(short paramShort) {
    if (paramShort <= 0 || paramShort > 16 || !GLOBAL_COMP[paramShort])
      return (XSNamedMap)XSNamedMapImpl.EMPTY_MAP; 
  ...
  public synchronized ObjectList getComponentsExt(short paramShort) {
    if (paramShort <= 0 || paramShort > 16 || !GLOBAL_COMP[paramShort])
      return (ObjectList)ObjectListImpl.EMPTY_LIST; 
    ...
    if (this.fComponentsExt[paramShort] == null) {
      ...
      this.fComponentsExt[paramShort] = (ObjectList)new ObjectListImpl(arrayOfObject, arrayOfObject.length);
    } 
  ...
  public XSIDCDefinition getIDCDefinition(String paramString) {
    return (XSIDCDefinition)getIDConstraintDecl(paramString);
  }
  ...
  public XSObjectList getAnnotations() {
    return (XSObjectList)((this.fNumAnnotations == 0) ? XSObjectListImpl.EMPTY_LIST : new XSObjectListImpl((XSObject[])this.fAnnotations, this.fNumAnnotations));
  }
  ...
  private static class XSAnyType extends XSComplexTypeDecl {
    ...
    public XSObjectList getAttributeUses() {
      return (XSObjectList)XSObjectListImpl.EMPTY_LIST;
    }
  ...
  public static class BuiltinSchemaGrammar extends SchemaGrammar {
    ...
    public BuiltinSchemaGrammar(int param1Int, short param1Short) {
      ...
      if (param1Int == 1) {
        ...
        this.fGlobalTypeDecls.getValues((Object[])arrayOfXSTypeDefinition, 0);
        for (byte b = 0; b < i; b++) {
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/xerces/impl/xs/SchemaGrammar.class
