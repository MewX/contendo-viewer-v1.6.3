    ...
    while (paramElement != null) {
      ...
      if (str.equals(SchemaSymbols.ELT_ENUMERATION)) {
        ...
        if (element != null && DOMUtil.getLocalName(element).equals(SchemaSymbols.ELT_ANNOTATION)) {
          xSObjectListImpl1.addXSObject(xSObjectListImpl1.getLength() - 1, (XSObject)traverseAnnotationDecl(element, arrayOfObject, false, paramXSDocumentInfo));
          element = DOMUtil.getNextSiblingElement(element);
        } else {
          String str2 = DOMUtil.getSyntheticAnnotation(paramElement);
          if (str2 != null)
            xSObjectListImpl1.addXSObject(xSObjectListImpl1.getLength() - 1, (XSObject)traverseSyntheticAnnotation(paramElement, str2, arrayOfObject, false, paramXSDocumentInfo)); 
        } 
        if (element != null)
        ...
        if (element != null && DOMUtil.getLocalName(element).equals(SchemaSymbols.ELT_ANNOTATION)) {
          ...
          xSObjectListImpl2.addXSObject((XSObject)traverseAnnotationDecl(element, arrayOfObject, false, paramXSDocumentInfo));
          element = DOMUtil.getNextSiblingElement(element);
        } else {
          String str2 = DOMUtil.getSyntheticAnnotation(paramElement);
          if (str2 != null) {
            if (xSObjectListImpl2 == null)
              xSObjectListImpl2 = new XSObjectListImpl(); 
            xSObjectListImpl2.addXSObject((XSObject)traverseSyntheticAnnotation(paramElement, str2, arrayOfObject, false, paramXSDocumentInfo));
          } 
        } 
        if (element != null)
        ...
        if (arrayOfObject[XSAttributeChecker.ATTIDX_VALUE] == null) {
          if (paramElement.getAttributeNodeNS((String)null, "value") == null)
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/xerces/impl/xs/traversers/XSDAbstractTraverser.class
