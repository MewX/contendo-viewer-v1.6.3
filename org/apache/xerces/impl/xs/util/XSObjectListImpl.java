...
public class XSObjectListImpl extends AbstractList implements XSObjectList {
  ...
  private ListIterator listIterator0(int paramInt) {
    return (this.fLength == 0) ? EMPTY_ITERATOR : new XSObjectListIterator(this, paramInt);
  }
  ...
  private final class XSObjectListIterator implements ListIterator {
    ...
    public XSObjectListIterator(XSObjectListImpl this$0, int param1Int) {
      this.this$0 = this$0;
    ...
    public Object next() {
      if (this.index < this.this$0.fLength)
        return this.this$0.fArray[this.index++]; 
      throw new NoSuchElementException();
    }
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/xerces/impl/xs/util/XSObjectListImpl.class
