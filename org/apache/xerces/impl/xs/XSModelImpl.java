...
public final class XSModelImpl extends AbstractList implements XSModel, XSNamespaceItemList {
  ...
  public XSModelImpl(SchemaGrammar[] paramArrayOfSchemaGrammar, short paramShort) {
    ...
    this.fNamespacesList = (StringList)new StringListImpl(this.fNamespaces, this.fGrammarCount);
  ...
  private SymbolHash buildSubGroups_Org() {
    ...
    for (byte b2 = 0; b2 < i; b2++) {
      ...
      symbolHash.put(xSElementDecl, (arrayOfXSElementDecl.length > 0) ? new XSObjectListImpl((XSObject[])arrayOfXSElementDecl, arrayOfXSElementDecl.length) : XSObjectListImpl.EMPTY_LIST);
    } 
    return symbolHash;
  }
  ...
  private XSObjectListImpl getGlobalElements() {
    ...
    for (byte b2 = 0; b2 < this.fGrammarCount; b2++) {
      arrayOfSymbolHash[b2].getValues((Object[])arrayOfXSObject, j);
      ...
      for (byte b = 0; b < this.fGrammarCount; b++) {
        switch (paramShort) {
          ...
          case 11:
            ...
            break;
          case 10:
            arrayOfSymbolHash[b] = (this.fGrammarList[b]).fGlobalIDConstraintDecls;
            break;
        } 
      } 
    ...
    if (this.fNSComponents[b][paramShort] == null) {
      ...
      switch (paramShort) {
        ...
        case 11:
          ...
          break;
        case 10:
          symbolHash = (this.fGrammarList[b]).fGlobalIDConstraintDecls;
          break;
      } 
      if (paramShort == 15 || paramShort == 16) {
  ...
  public XSIDCDefinition getIDCDefinition(String paramString1, String paramString2) {
    SchemaGrammar schemaGrammar = (SchemaGrammar)this.fGrammarMap.get(null2EmptyString(paramString2));
    return (schemaGrammar == null) ? null : (XSIDCDefinition)schemaGrammar.fGlobalIDConstraintDecls.get(paramString1);
  }
  
  public XSIDCDefinition getIDCDefinition(String paramString1, String paramString2, String paramString3) {
    SchemaGrammar schemaGrammar = (SchemaGrammar)this.fGrammarMap.get(null2EmptyString(paramString2));
    return (XSIDCDefinition)((schemaGrammar == null) ? null : schemaGrammar.getIDConstraintDecl(paramString1, paramString3));
  }
  ...
  public synchronized XSObjectList getAnnotations() {
    ...
    if (i == 0) {
      this.fAnnotations = (XSObjectList)XSObjectListImpl.EMPTY_LIST;
      return this.fAnnotations;
    } 
    ...
    this.fAnnotations = (XSObjectList)new XSObjectListImpl((XSObject[])arrayOfXSAnnotationImpl, arrayOfXSAnnotationImpl.length);
    return this.fAnnotations;
  }
  ...
  public XSNamespaceItem item(int paramInt) {
    return (paramInt < 0 || paramInt >= this.fGrammarCount) ? null : this.fGrammarList[paramInt];
  }
  ...
  private ListIterator listIterator0(int paramInt) {
    return new XSNamespaceItemListIterator(this, paramInt);
  }
  ...
  private final class XSNamespaceItemListIterator implements ListIterator {
    ...
    public XSNamespaceItemListIterator(XSModelImpl this$0, int param1Int) {
      this.this$0 = this$0;
    ...
    public Object next() {
      if (this.index < this.this$0.fGrammarCount)
        return this.this$0.fGrammarList[this.index++]; 
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/xerces/impl/xs/XSModelImpl.class
