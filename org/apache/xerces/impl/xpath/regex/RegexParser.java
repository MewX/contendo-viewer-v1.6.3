...
class RegexParser {
  ...
  protected RangeToken parseCharacterClass(boolean paramBoolean) throws ParseException {
    ...
    int i;
    for (boolean bool2 = true; (i = read()) != 1 && (i != 0 || this.chardata != 93 || bool2); bool2 = false) {
      int j = this.chardata;
      boolean bool = false;
      if (i == 10) {
        int k;
  ...
  protected static final void addCaseInsensitiveChar(RangeToken paramRangeToken, int paramInt) {
    ...
    if (arrayOfInt != null)
      for (byte b = 0; b < arrayOfInt.length; b += 2)
        paramRangeToken.addRange(arrayOfInt[b], arrayOfInt[b]);  
  }
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/xerces/impl/xpath/regex/RegexParser.class
