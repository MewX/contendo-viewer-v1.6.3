      ...
      if (!bool) {
        ...
        if (read() != 0 || this.chardata != 45 || (j == 45 && bool3)) {
          if (!isSet(2) || j > 65535) {
            ...
            RegexParser.addCaseInsensitiveChar(rangeToken2, j);
          } 
        } else {
          next();
          if ((i = read()) == 1)
          ...
          if (i == 0 && this.chardata == 93) {
            ...
            if (!isSet(2) || (j > 65535 && k > 65535)) {
              ...
              RegexParser.addCaseInsensitiveCharRange(rangeToken2, j, k);
            } 
          } 
        } 
      } 
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/xerces/impl/xpath/regex/ParserForXMLSchema.class
