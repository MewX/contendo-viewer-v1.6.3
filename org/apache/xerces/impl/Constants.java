...
public final class Constants {
  ...
  private static final String[] fgXercesFeatures = new String[] { 
      ...
      "validate-annotations", "honour-all-schemaLocations", "xinclude", "xinclude/fixup-base-uris", "xinclude/fixup-language", "validation/schema/ignore-xsi-type-until-elemdecl", "validation/id-idref-checking", "validation/identity-constraint-checking", "validation/unparsed-entity-checking", "namespace-growth", 
      "internal/tolerate-duplicates", "internal/strings-interned" };
  ...
  private static final String[] fgXercesProperties = new String[] { 
      ...
      "internal/dtd-scanner", "internal/validator", "schema/external-schemaLocation", "schema/external-noNamespaceSchemaLocation", "internal/validation-manager", "input-buffer-size", "security-manager", "locale", "validation/schema/root-type-definition", "validation/schema/root-element-declaration", 
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/xerces/impl/Constants.class
