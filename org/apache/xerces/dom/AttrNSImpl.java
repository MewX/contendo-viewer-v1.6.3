...
public class AttrNSImpl extends AttrImpl {
  ...
  public boolean isDerivedFrom(String paramString1, String paramString2, int paramInt) {
    return (this.type != null && this.type instanceof XSSimpleTypeDecl) ? ((XSSimpleTypeDecl)this.type).isDOMDerivedFrom(paramString1, paramString2, paramInt) : false;
  }
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/xerces/dom/AttrNSImpl.class
