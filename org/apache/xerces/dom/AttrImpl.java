...
public class AttrImpl extends NodeImpl implements Attr, TypeInfo {
  ...
  public void setValue(String paramString) {
    ...
    if (coreDocumentImpl.getMutationEvents()) {
      if (textImpl == null) {
        textImpl = (TextImpl)coreDocumentImpl.createTextNode(paramString);
      } else {
        textImpl.data = paramString;
      } 
      internalInsertBefore(textImpl, (Node)null, true);
      hasStringValue(false);
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/xerces/dom/AttrImpl.class
