...
public class NamedNodeMapImpl implements Serializable, NamedNodeMap {
  ...
  public Node item(int paramInt) {
    return (this.nodes != null && paramInt < this.nodes.size()) ? this.nodes.get(paramInt) : null;
  }
  ...
  protected void cloneContent(NamedNodeMapImpl paramNamedNodeMapImpl) {
    ...
    if (list != null) {
      ...
      if (i != 0) {
        ...
        for (byte b = 0; b < i; b++) {
          NodeImpl nodeImpl1 = paramNamedNodeMapImpl.nodes.get(b);
  ...
  protected int findNamePoint(String paramString1, String paramString2) {
    ...
    int i = this.nodes.size();
    for (byte b = 0; b < i; b++) {
      NodeImpl nodeImpl = this.nodes.get(b);
  ...
  protected Object getItem(int paramInt) {
    return (this.nodes != null) ? this.nodes.get(paramInt) : null;
  }
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/xerces/dom/NamedNodeMapImpl.class
