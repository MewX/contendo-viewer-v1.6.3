...
/* 2466 */     Locale locale = Locale.getDefault();
/* 2467 */     String suffix = getResourceSuffix(locale);
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */     
/* 2473 */     try { return (XSLTErrorResources)ResourceBundle.getBundle(className + suffix, locale); } catch (MissingResourceException e)
/*      */     
/*      */     { 
/*      */       
/*      */       try { 
...
/*      */ 
/*      */         
/* 2483 */         return (XSLTErrorResources)ResourceBundle.getBundle(className, new Locale("en", "US")); } catch (MissingResourceException e2)
/*      */       
/*      */       { 
/*      */ 
/*      */ 
...
/*      */ 
/*      */         
/* 2491 */         throw new MissingResourceException("Could not load any resource bundles.", className, ""); }
/*      */        }
/*      */   
/*      */   }
/*      */ 
...
/* 2508 */     String suffix = "_" + locale.getLanguage();
/* 2509 */     String country = locale.getCountry();
/*      */     
/* 2511 */     if (country.equals("TW")) {
/* 2512 */       suffix = suffix + "_" + country;
/*      */     }
/* 2514 */     return suffix;
/*      */   }
/*      */ }
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/xalan/res/XSLTErrorResources.class
