...
/* 2425 */     Locale locale = Locale.getDefault();
/* 2426 */     String suffix = getResourceSuffix(locale);
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */     
/* 2432 */     try { return (XSLTErrorResources)ResourceBundle.getBundle(className + suffix, locale); } catch (MissingResourceException e)
/*      */     
/*      */     { 
/*      */       
/*      */       try { 
...
/*      */ 
/*      */         
/* 2442 */         return (XSLTErrorResources)ResourceBundle.getBundle(className, new Locale("pt", "BR")); } catch (MissingResourceException e2)
/*      */       
/*      */       { 
/*      */ 
/*      */ 
...
/*      */ 
/*      */         
/* 2450 */         throw new MissingResourceException("Could not load any resource bundles.", className, ""); }
/*      */        }
/*      */   
/*      */   }
/*      */ 
...
/* 2467 */     String suffix = "_" + locale.getLanguage();
/* 2468 */     String country = locale.getCountry();
/*      */     
/* 2470 */     if (country.equals("TW")) {
/* 2471 */       suffix = suffix + "_" + country;
/*      */     }
/* 2473 */     return suffix;
/*      */   }
/*      */ }
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/xalan/res/XSLTErrorResources_pt_BR.class
