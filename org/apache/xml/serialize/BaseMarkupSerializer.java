...
public abstract class BaseMarkupSerializer implements DOMSerializer, Serializer, ContentHandler, DTDHandler, DocumentHandler, DeclHandler, LexicalHandler {
  ...
  protected void printEscaped(int paramInt) throws IOException {
    ...
    if (str != null) {
      ...
      this._printer.printText(';');
    } else if ((paramInt >= 32 && this._encodingInfo.isPrintable((char)paramInt) && paramInt != 127) || paramInt == 10 || paramInt == 13 || paramInt == 9) {
      if (paramInt < 65536) {
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/xml/serialize/BaseMarkupSerializer.class
