...
public class HTMLSerializer extends BaseMarkupSerializer {
  ...
  public void startElement(String paramString1, String paramString2, String paramString3, Attributes paramAttributes) throws SAXException {
    ...
    try {
      ...
      if (str != null && HTMLdtd.isPreserveSpace(str))
        bool1 = true; 
      if (bool) {
        Iterator iterator = this._prefixes.entrySet().iterator();
  ...
  public void endElement(String paramString) throws SAXException {
    endElement((String)null, (String)null, paramString);
  }
  ...
  protected void serializeElement(Element paramElement) throws IOException {
    ...
    if (paramElement.hasChildNodes() || !HTMLdtd.isEmptyTag(str)) {
      ...
      for (Node node = paramElement.getFirstChild(); node != null; node = node.getNextSibling())
        serializeNode(node); 
      endElementIO((String)null, (String)null, str);
    } else {
      this._printer.unindent();
      if (this._xhtml) {
        this._printer.printText(" />");
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/xml/serialize/HTMLSerializer.class
