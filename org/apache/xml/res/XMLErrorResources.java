...
/* 464 */     Locale locale = Locale.getDefault();
/* 465 */     String suffix = getResourceSuffix(locale);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 471 */     try { return (XMLErrorResources)ResourceBundle.getBundle(className + suffix, locale); } catch (MissingResourceException e)
/*     */     
/*     */     { 
/*     */       
/*     */       try { 
...
/*     */ 
/*     */         
/* 481 */         return (XMLErrorResources)ResourceBundle.getBundle(className, new Locale("en", "US")); } catch (MissingResourceException e2)
/*     */       
/*     */       { 
/*     */ 
/*     */ 
...
/*     */ 
/*     */         
/* 489 */         throw new MissingResourceException("Could not load any resource bundles.", className, ""); }
/*     */        }
/*     */   
/*     */   }
/*     */ 
...
/* 506 */     String suffix = "_" + locale.getLanguage();
/* 507 */     String country = locale.getCountry();
/*     */     
/* 509 */     if (country.equals("TW")) {
/* 510 */       suffix = suffix + "_" + country;
/*     */     }
/* 512 */     return suffix;
/*     */   }
/*     */ }
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/xml/res/XMLErrorResources.class
