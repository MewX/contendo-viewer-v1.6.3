...
/* 1282 */     Locale locale = Locale.getDefault();
/* 1283 */     String suffix = getResourceSuffix(locale);
/*      */ 
/*      */ 
/*      */ 
/*      */ 
/*      */     
/* 1289 */     try { return (XPATHErrorResources)ResourceBundle.getBundle(className + suffix, locale); } catch (MissingResourceException e)
/*      */     
/*      */     { 
/*      */       
/*      */       try { 
...
/*      */ 
/*      */         
/* 1299 */         return (XPATHErrorResources)ResourceBundle.getBundle(className, new Locale("zh", "TW")); } catch (MissingResourceException e2)
/*      */       
/*      */       { 
/*      */ 
/*      */ 
...
/*      */ 
/*      */         
/* 1307 */         throw new MissingResourceException("Could not load any resource bundles.", className, ""); }
/*      */        }
/*      */   
/*      */   }
/*      */ 
...
/* 1324 */     String suffix = "_" + locale.getLanguage();
/* 1325 */     String country = locale.getCountry();
/*      */     
/* 1327 */     if (country.equals("TW")) {
/* 1328 */       suffix = suffix + "_" + country;
/*      */     }
/* 1330 */     return suffix;
/*      */   }
/*      */ }
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/xpath/res/XPATHErrorResources_zh_TW.class
