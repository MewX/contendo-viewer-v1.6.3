...
/* 237 */   protected HashSet modifierKeys = new HashSet();
/*     */ 
/*     */ 
/*     */ 
/*     */   
...
/* 253 */     return this.modifierKeys.contains("Control");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 260 */     return this.modifierKeys.contains("Shift");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 267 */     return this.modifierKeys.contains("Alt");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 275 */     return this.modifierKeys.contains("Meta");
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 297 */     return this.modifierKeys.contains(keyIdentifierArg);
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* 322 */     initUIEvent(typeArg, canBubbleArg, cancelableArg, viewArg, 0);
/* 323 */     this.keyIdentifier = keyIdentifierArg;
/* 324 */     this.keyLocation = keyLocationArg;
/* 325 */     this.modifierKeys.clear();
/* 326 */     String[] modifiers = split(modifiersList);
/* 327 */     for (String modifier : modifiers) {
/* 328 */       this.modifierKeys.add(modifier);
/*     */     }
/*     */   }
/*     */ 
/*     */ 
...
/* 356 */     initUIEventNS(namespaceURIArg, typeArg, canBubbleArg, cancelableArg, viewArg, 0);
/*     */ 
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 362 */     this.keyIdentifier = keyIdentifierArg;
/* 363 */     this.keyLocation = keyLocationArg;
/* 364 */     this.modifierKeys.clear();
/* 365 */     String[] modifiers = split(modifiersList);
/* 366 */     for (String modifier : modifiers)
/* 367 */       this.modifierKeys.add(modifier); 
/*     */   }
/*     */ }


/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/batik/dom/events/DOMKeyboardEvent.class
