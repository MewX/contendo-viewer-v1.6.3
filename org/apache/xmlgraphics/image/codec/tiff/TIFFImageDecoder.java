...
/* 77 */     super(input, param);
/*    */   }
/*    */   
/*    */   public int getNumPages() throws IOException {
/* 81 */     return TIFFDirectory.getNumDirectories(this.input);
/*    */   }
/*    */   
/*    */   public RenderedImage decodeAsRenderedImage(int page) throws IOException {
/* 85 */     if (page < 0 || page >= getNumPages()) {
/* 86 */       throw new IOException(PropertyUtil.getString("TIFFImageDecoder0"));
/*    */     }
/* 88 */     return (RenderedImage)new TIFFImage(this.input, (TIFFDecodeParam)this.param, page);
/*    */   }
/*    */ }


/* Location:              /mnt/r/ConTenDoViewer.jar!/org/apache/xmlgraphics/image/codec/tiff/TIFFImageDecoder.class
