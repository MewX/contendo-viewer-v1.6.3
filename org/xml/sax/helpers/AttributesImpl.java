...
public class AttributesImpl implements Attributes {
  ...
  public String getURI(int paramInt) {
    return (paramInt >= 0 && paramInt < this.length) ? this.data[paramInt * 5] : null;
  }
  
  public String getLocalName(int paramInt) {
    return (paramInt >= 0 && paramInt < this.length) ? this.data[paramInt * 5 + 1] : null;
  }
  
  public String getQName(int paramInt) {
    return (paramInt >= 0 && paramInt < this.length) ? this.data[paramInt * 5 + 2] : null;
  }
  
  public String getType(int paramInt) {
    return (paramInt >= 0 && paramInt < this.length) ? this.data[paramInt * 5 + 3] : null;
  }
  
  public String getValue(int paramInt) {
    return (paramInt >= 0 && paramInt < this.length) ? this.data[paramInt * 5 + 4] : null;
  }
  
  public int getIndex(String paramString1, String paramString2) {
    int i = this.length * 5;
    for (byte b = 0; b < i; b += 5) {
      if (this.data[b].equals(paramString1) && this.data[b + 1].equals(paramString2))
        return b / 5; 
    } 
    return -1;
  }
  ...
  public int getIndex(String paramString) {
    int i = this.length * 5;
    for (byte b = 0; b < i; b += 5) {
      if (this.data[b + 2].equals(paramString))
        return b / 5; 
    } 
    return -1;
  }
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/org/xml/sax/helpers/AttributesImpl.class
