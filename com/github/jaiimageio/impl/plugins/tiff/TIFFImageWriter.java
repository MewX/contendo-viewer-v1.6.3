...
/*  107 */   public static final String[] TIFFCompressionTypes = new String[] { "CCITT RLE", "CCITT T.4", "CCITT T.6", "LZW", "JPEG", "ZLib", "PackBits", "Deflate", "EXIF JPEG" };
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  129 */   public static final String[] compressionTypes = new String[] { "CCITT RLE", "CCITT T.4", "CCITT T.6", "LZW", "Old JPEG", "JPEG", "ZLib", "PackBits", "Deflate", "EXIF JPEG" };
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  145 */   public static final boolean[] isCompressionLossless = new boolean[] { true, true, true, true, false, false, true, true, true, false };
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  161 */   public static final int[] compressionNumbers = new int[] { 2, 3, 4, 5, 6, 7, 8, 32773, 32946, 6 };
/*      */   
...
/*      */   int tilesAcross;
/*      */   int tilesDown;
/*  201 */   int[] sampleSize = null;
/*  202 */   int scalingBitDepth = -1;
/*      */   
...
/*      */   char[] bitsPerSample;
/*  215 */   int sampleFormat = 4;
/*      */ 
/*      */ 
/*      */   
/*  219 */   byte[][] scale = (byte[][])null;
/*  220 */   byte[] scale0 = null;
/*      */ 
/*      */   
/*  223 */   byte[][] scaleh = (byte[][])null;
/*  224 */   byte[][] scalel = (byte[][])null;
/*      */   
/*      */   int compression;
/*      */   
/*      */   int predictor;
...
/*  252 */     x -= tileGridXOffset;
/*  253 */     if (x < 0) {
/*  254 */       x += 1 - tileWidth;
/*      */     }
/*  256 */     return x / tileWidth;
/*      */   }
/*      */ 
/*      */ 
/*      */ 
...
/*  271 */     y -= tileGridYOffset;
/*  272 */     if (y < 0) {
/*  273 */       y += 1 - tileHeight;
/*      */     }
/*  275 */     return y / tileHeight;
/*      */   }
...
/* 3629 */     this.compressor = null;
/* 3630 */     this.colorConverter = null;
/* 3631 */     this.streamMetadata = null;
/* 3632 */     this.imageMetadata = null;
/*      */     
/* 3634 */     this.isWritingSequence = false;
/* 3635 */     this.isWritingEmpty = false;
/* 3636 */     this.isInsertingEmpty = false;
/*      */     
/* 3638 */     this.replacePixelsIndex = -1;
/* 3639 */     this.replacePixelsMetadata = null;
/* 3640 */     this.replacePixelsTileOffsets = null;
/* 3641 */     this.replacePixelsByteCounts = null;
/* 3642 */     this.replacePixelsOffsetsPosition = 0L;
/* 3643 */     this.replacePixelsByteCountsPosition = 0L;
/* 3644 */     this.replacePixelsRegion = null;
/* 3645 */     this.inReplacePixelsNest = false;
/*      */   }
/*      */   
/*      */   public void dispose() {
/* 3649 */     reset();
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/com/github/jaiimageio/impl/plugins/tiff/TIFFImageWriter.class
