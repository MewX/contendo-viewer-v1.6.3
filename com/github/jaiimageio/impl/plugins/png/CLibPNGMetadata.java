...
/*  106 */   public static final String[] IHDR_colorTypeNames = new String[] { "Grayscale", null, "RGB", "Palette", "GrayAlpha", null, "RGBAlpha" };
/*      */ 
/*      */ 
/*      */ 
/*      */   
/*  111 */   public static final int[] IHDR_numChannels = new int[] { 1, 0, 3, 3, 2, 0, 4 };
/*      */ 
/*      */ 
/*      */ 
/*      */   
/*  116 */   public static final String[] IHDR_bitDepths = new String[] { "1", "2", "4", "8", "16" };
/*      */ 
/*      */ 
/*      */ 
/*      */   
/*  121 */   public static final String[] IHDR_compressionMethodNames = new String[] { "deflate" };
/*      */ 
/*      */ 
/*      */ 
/*      */   
/*  126 */   public static final String[] IHDR_filterMethodNames = new String[] { "adaptive" };
/*      */ 
/*      */ 
/*      */ 
/*      */   
/*  131 */   public static final String[] IHDR_interlaceMethodNames = new String[] { "none", "adam7" };
/*      */ 
/*      */ 
/*      */ 
/*      */   
/*  136 */   public static final String[] iCCP_compressionMethodNames = new String[] { "deflate" };
/*      */ 
/*      */ 
/*      */ 
/*      */   
/*  141 */   public static final String[] zTXt_compressionMethodNames = new String[] { "deflate" };
/*      */ 
/*      */ 
/*      */   
...
/*      */ 
/*      */   
/*  152 */   public static final String[] unitSpecifierNames = new String[] { "unknown", "meter" };
/*      */ 
/*      */ 
/*      */ 
/*      */   
/*  157 */   public static final String[] renderingIntentNames = new String[] { "Perceptual", "Relative colorimetric", "Saturation", "Absolute colorimetric" };
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */   
/*  166 */   public static final String[] colorSpaceTypeNames = new String[] { "GRAY", null, "RGB", "RGB", "GRAY", null, "RGB" };
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*  256 */   public ArrayList iTXt_keyword = new ArrayList();
/*  257 */   public ArrayList iTXt_compressionFlag = new ArrayList();
/*  258 */   public ArrayList iTXt_compressionMethod = new ArrayList();
/*  259 */   public ArrayList iTXt_languageTag = new ArrayList();
/*  260 */   public ArrayList iTXt_translatedKeyword = new ArrayList();
/*  261 */   public ArrayList iTXt_text = new ArrayList();
/*      */   
...
/*  293 */   public ArrayList tEXt_keyword = new ArrayList();
/*  294 */   public ArrayList tEXt_text = new ArrayList();
/*      */   
...
/*  317 */   public ArrayList zTXt_keyword = new ArrayList();
/*  318 */   public ArrayList zTXt_compressionMethod = new ArrayList();
/*  319 */   public ArrayList zTXt_text = new ArrayList();
/*      */ 
/*      */   
/*  322 */   public ArrayList unknownChunkType = new ArrayList();
/*  323 */   public ArrayList unknownChunkData = new ArrayList();
/*      */ 
/*      */ 
/*      */   
...
/*  352 */       if (prev != 32 || d != 32) {
/*      */         
/*  354 */         if ((d > 32 && d <= 126) || (d >= 161 && d <= 255) || (d == 32 && len != 0))
/*      */         {
/*  356 */           data[len++] = (byte)d; } 
/*  357 */         prev = d;
/*      */       } 
...
/*      */ 
/*      */     
/* 2132 */     this.gotHeader = false;
/* 2133 */     this.gotMetadata = false; }
...
/* 2147 */   private String readNullTerminatedString(ImageInputStream stream) throws IOException { StringBuffer b = new StringBuffer();
/*      */     
/*      */     int c;
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/com/github/jaiimageio/impl/plugins/png/CLibPNGMetadata.class
