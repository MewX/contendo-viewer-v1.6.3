...
/*      */ 
/*      */           
/* 1773 */           closure_rtype = (Structure.FFIType.get(rclass.isPrimitive() ? rclass : Pointer.class)).peer;
/* 1774 */           rtype = (Structure.FFIType.get(fromNative.nativeType())).peer;
/*      */           break;
/*      */         case 17:
/*      */         case 18:
/*      */         case 19:
/*      */         case 21:
/*      */         case 22:
/* 1781 */           closure_rtype = (Structure.FFIType.get(Pointer.class)).peer;
/* 1782 */           rtype = (Structure.FFIType.get(NativeMappedConverter.getInstance(rclass).nativeType())).peer;
/*      */           break;
/*      */         case 3:
/*      */         case 26:
/* 1786 */           closure_rtype = rtype = (Structure.FFIType.get(Pointer.class)).peer;
/*      */         
/*      */         case 4:
/* 1789 */           closure_rtype = (Structure.FFIType.get(Pointer.class)).peer;
/* 1790 */           rtype = (Structure.FFIType.get(rclass)).peer;
/*      */           break;
/*      */         default:
/* 1793 */           closure_rtype = rtype = (Structure.FFIType.get(rclass)).peer;
/*      */           break;
/*      */       } 
...
/*      */           case 21:
/*      */           case 22:
/* 1825 */             atypes[t] = (Structure.FFIType.get(type)).peer;
/* 1826 */             closure_atypes[t] = (Structure.FFIType.get(Pointer.class)).peer;
/*      */             break;
/*      */           case 23:
/*      */           case 24:
/*      */           case 25:
/* 1831 */             closure_atypes[t] = (Structure.FFIType.get(type.isPrimitive() ? type : Pointer.class)).peer;
/* 1832 */             atypes[t] = (Structure.FFIType.get(toNative[t].nativeType())).peer;
/*      */             break;
/*      */           case 0:
/* 1835 */             atypes[t] = (Structure.FFIType.get(type)).peer; closure_atypes[t] = (Structure.FFIType.get(type)).peer;
/*      */           
/*      */           default:
/* 1838 */             atypes[t] = (Structure.FFIType.get(Pointer.class)).peer; closure_atypes[t] = (Structure.FFIType.get(Pointer.class)).peer; break;
/*      */         } 
/*      */       } 
/* 1841 */       sig = sig + ")";
...
/* 1960 */     String DEFAULT_VERSION = "5.3.1";
/* 1961 */     String DEFAULT_BUILD = "5.3.1 (package information missing)";
...
/*      */     
/* 1967 */     String version = (pkg != null) ? pkg.getSpecificationVersion() : "5.3.1";
/* 1968 */     if (version == null) version = "5.3.1"; 
/* 1969 */     title = title + " API Version " + version;
/* 1970 */     System.out.println(title);
/*      */     
/* 1972 */     version = (pkg != null) ? pkg.getImplementationVersion() : "5.3.1 (package information missing)";
/* 1973 */     if (version == null) version = "5.3.1 (package information missing)"; 
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/com/sun/jna/Native.class
