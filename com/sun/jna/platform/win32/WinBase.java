...
/*      */     extends Structure
/*      */   {
/* 1280 */     public WinDef.DWORD dwLength = new WinDef.DWORD(size());
/*      */ 
/*      */     
...
/*      */     extends Structure
/*      */   {
/* 1310 */     public WinDef.DWORD dwLength = new WinDef.DWORD(size());
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*      */     public STARTUPINFO() {
/* 1483 */       super(W32APITypeMapper.DEFAULT);
/* 1484 */       this.cb = new WinDef.DWORD(size());
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/* 1841 */         stringBuilder.append("fBinary:1=");
/* 1842 */         stringBuilder.append(getfBinary() ? 49 : 48);
/* 1843 */         stringBuilder.append(", fParity:1=");
/* 1844 */         stringBuilder.append(getfParity() ? 49 : 48);
/* 1845 */         stringBuilder.append(", fOutxCtsFlow:1=");
/* 1846 */         stringBuilder.append(getfOutxCtsFlow() ? 49 : 48);
/* 1847 */         stringBuilder.append(", fOutxDsrFlow:1=");
/* 1848 */         stringBuilder.append(getfOutxDsrFlow() ? 49 : 48);
/* 1849 */         stringBuilder.append(", fDtrControl:2=");
/* 1850 */         stringBuilder.append(getfDtrControl());
/* 1851 */         stringBuilder.append(", fDsrSensitivity:1=");
/* 1852 */         stringBuilder.append(getfDsrSensitivity() ? 49 : 48);
/* 1853 */         stringBuilder.append(", fTXContinueOnXoff:1=");
/* 1854 */         stringBuilder.append(getfTXContinueOnXoff() ? 49 : 48);
/* 1855 */         stringBuilder.append(", fOutX:1=");
/* 1856 */         stringBuilder.append(getfOutX() ? 49 : 48);
/* 1857 */         stringBuilder.append(", fInX:1=");
/* 1858 */         stringBuilder.append(getfInX() ? 49 : 48);
/* 1859 */         stringBuilder.append(", fErrorChar:1=");
/* 1860 */         stringBuilder.append(getfErrorChar() ? 49 : 48);
/* 1861 */         stringBuilder.append(", fNull:1=");
/* 1862 */         stringBuilder.append(getfNull() ? 49 : 48);
/* 1863 */         stringBuilder.append(", fRtsControl:2=");
/* 1864 */         stringBuilder.append(getfRtsControl());
/* 1865 */         stringBuilder.append(", fAbortOnError:1=");
/* 1866 */         stringBuilder.append(getfAbortOnError() ? 49 : 48);
/* 1867 */         stringBuilder.append(", fDummy2:17=");
/* 1868 */         stringBuilder.append(getfDummy2());
/* 1869 */         stringBuilder.append('>');
/* 1870 */         return stringBuilder.toString();
/*      */       }
/*      */       
/*      */       public boolean getfAbortOnError() {
/* 1874 */         return ((intValue() & 0x4000) != 0);
/*      */       }
/*      */       
/*      */       public boolean getfBinary() {
/* 1878 */         return ((intValue() & 0x1) != 0);
/*      */       }
/*      */       
/*      */       public boolean getfDsrSensitivity() {
/* 1882 */         return ((intValue() & 0x40) != 0);
/*      */       }
/*      */       
/*      */       public int getfDtrControl() {
/* 1886 */         return intValue() >>> 4 & 0x3;
/*      */       }
/*      */       
/*      */       public boolean getfErrorChar() {
/* 1890 */         return ((intValue() & 0x400) != 0);
/*      */       }
/*      */       
/*      */       public boolean getfInX() {
/* 1894 */         return ((intValue() & 0x200) != 0);
/*      */       }
/*      */       
/*      */       public boolean getfNull() {
/* 1898 */         return ((intValue() & 0x800) != 0);
/*      */       }
/*      */       
/*      */       public boolean getfOutX() {
/* 1902 */         return ((intValue() & 0x100) != 0);
/*      */       }
/*      */       
/*      */       public boolean getfOutxCtsFlow() {
/* 1906 */         return ((intValue() & 0x4) != 0);
/*      */       }
/*      */       
/*      */       public boolean getfOutxDsrFlow() {
/* 1910 */         return ((intValue() & 0x8) != 0);
/*      */       }
/*      */       
/*      */       public boolean getfParity() {
/* 1914 */         return ((intValue() & 0x2) != 0);
/*      */       }
/*      */       
/*      */       public int getfRtsControl() {
/* 1918 */         return intValue() >>> 12 & 0x3;
/*      */       }
/*      */       
/*      */       public int getfDummy2() {
/* 1922 */         return intValue() >>> 15 & 0x1FFFF;
/*      */       }
/*      */       
/*      */       public boolean getfTXContinueOnXoff() {
/* 1926 */         return ((intValue() & 0x80) != 0);
/*      */       }
/*      */ 
/*      */ 
/*      */ 
...
/* 1939 */         int tmp = leftShiftMask(fAbortOnError ? 1 : 0, (byte)14, 1, intValue());
/* 1940 */         setValue(tmp);
/*      */       }
/*      */ 
/*      */ 
...
/* 1951 */         int tmp = leftShiftMask(fBinary ? 1 : 0, (byte)0, 1, intValue());
/* 1952 */         setValue(tmp);
/*      */       }
/*      */ 
/*      */ 
...
/* 1964 */         int tmp = leftShiftMask(fDsrSensitivity ? 1 : 0, (byte)6, 1, intValue());
/* 1965 */         setValue(tmp);
/*      */       }
/*      */ 
/*      */ 
...
/* 1979 */         int tmp = leftShiftMask(fOutxDsrFlow, (byte)4, 3, intValue());
/* 1980 */         setValue(tmp);
/*      */       }
/*      */ 
/*      */ 
...
/* 1992 */         int tmp = leftShiftMask(fErrorChar ? 1 : 0, (byte)10, 1, intValue());
/* 1993 */         setValue(tmp);
/*      */       }
/*      */ 
/*      */ 
...
/* 2006 */         int tmp = leftShiftMask(fInX ? 1 : 0, (byte)9, 1, intValue());
/* 2007 */         setValue(tmp);
/*      */       }
/*      */ 
/*      */ 
...
/* 2016 */         int tmp = leftShiftMask(fNull ? 1 : 0, (byte)11, 1, intValue());
/* 2017 */         setValue(tmp);
/*      */       }
/*      */ 
/*      */ 
...
/* 2030 */         int tmp = leftShiftMask(fOutX ? 1 : 0, (byte)8, 1, intValue());
/* 2031 */         setValue(tmp);
/*      */       }
/*      */ 
/*      */ 
...
/* 2043 */         int tmp = leftShiftMask(fOutxCtsFlow ? 1 : 0, (byte)2, 1, intValue());
/* 2044 */         setValue(tmp);
/*      */       }
/*      */ 
/*      */ 
...
/* 2056 */         int tmp = leftShiftMask(fOutxDsrFlow ? 1 : 0, (byte)3, 1, intValue());
/* 2057 */         setValue(tmp);
/*      */       }
/*      */ 
/*      */ 
...
/* 2067 */         int tmp = leftShiftMask(fParity ? 1 : 0, (byte)1, 1, intValue());
/* 2068 */         setValue(tmp);
/*      */       }
/*      */ 
/*      */ 
...
/* 2083 */         int tmp = leftShiftMask(fRtsControl, (byte)12, 3, intValue());
/* 2084 */         setValue(tmp);
/*      */       }
/*      */ 
/*      */ 
...
/* 2098 */         int tmp = leftShiftMask(fTXContinueOnXoff ? 1 : 0, (byte)7, 1, intValue());
/* 2099 */         setValue(tmp);
/*      */       }
/*      */ 
/*      */       
/*      */       private static int leftShiftMask(int valuetoset, byte shift, int mask, int storage) {
/* 2104 */         int tmp = storage;
/* 2105 */         tmp &= mask << shift ^ 0xFFFFFFFF;
/* 2106 */         tmp |= (valuetoset & mask) << shift;
/* 2107 */         return tmp;
/*      */       }
/*      */     }
/*      */ 
...
/*      */     
/*      */     public DCB() {
/* 2226 */       this.DCBlength = new WinDef.DWORD(size());
/*      */     }
/*      */   }
/*      */   
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/com/sun/jna/platform/win32/WinBase.class
