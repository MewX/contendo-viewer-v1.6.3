...
/*  335 */       super((Pointer)new Memory(size));
/*      */     }
/*      */     
...
/*  354 */       super((Pointer)new Memory(data.length));
/*  355 */       getPointer().write(0L, data, 0, data.length);
/*  356 */       read();
/*      */     }
/*      */     
/*      */     public PSID(int size) {
/*  360 */       super((Pointer)new Memory(size));
/*      */     }
/*      */     
...
/*  369 */       int len = Advapi32.INSTANCE.GetLengthSid(this);
/*  370 */       return getPointer().getByteArray(0L, len);
/*      */     }
/*      */     
/*      */     public String getSidString() {
/*  374 */       return Advapi32Util.convertSidToStringSid(this);
/*      */     }
/*      */   }
/*      */   
...
/*  384 */       super(Native.POINTER_SIZE);
/*  385 */       setValue(h);
/*      */     }
/*      */     
/*      */     public void setValue(WinNT.PSID h) {
/*  389 */       getPointer().setPointer(0L, (h != null) ? h.getPointer() : null);
/*      */     }
/*      */     
/*      */     public WinNT.PSID getValue() {
/*  393 */       Pointer p = getPointer().getPointer(0L);
/*  394 */       if (p == null) {
/*  395 */         return null;
/*      */       }
/*      */       
/*  398 */       return new WinNT.PSID(p);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*  426 */       super((Pointer)new Memory(size));
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*  452 */       super((Pointer)new Memory(size));
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  461 */       return (WinNT.SID_AND_ATTRIBUTES[])this.Group0.toArray(this.GroupCount);
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/*  483 */       this.PrivilegeCount = new WinDef.DWORD(nbOfPrivileges);
/*  484 */       if (nbOfPrivileges > 0) {
/*  485 */         this.Privileges = new WinNT.LUID_AND_ATTRIBUTES[nbOfPrivileges];
/*      */       }
/*      */     }
/*      */ 
/*      */ 
...
/*  493 */       super(p);
/*  494 */       int count = p.getInt(0L);
/*  495 */       this.PrivilegeCount = new WinDef.DWORD(count);
/*  496 */       if (count > 0) {
/*  497 */         this.Privileges = new WinNT.LUID_AND_ATTRIBUTES[count];
/*      */       }
/*  499 */       read();
/*      */     }
/*      */   }
...
/*  529 */       this.PrivilegeCount = new WinDef.DWORD(nbOfPrivileges);
/*  530 */       this.Privileges = new WinNT.LUID_AND_ATTRIBUTES[nbOfPrivileges];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  537 */       super(p);
/*  538 */       int count = p.getInt(0L);
/*  539 */       this.PrivilegeCount = new WinDef.DWORD(count);
/*  540 */       this.Privileges = new WinNT.LUID_AND_ATTRIBUTES[count];
/*  541 */       read();
/*      */     }
/*      */   }
/*      */ 
...
/*      */ 
/*      */     
/*  859 */     public char[] FileName = new char[1];
/*      */ 
/*      */     
...
/*  866 */       if (size < size()) {
/*  867 */         throw new IllegalArgumentException("Size must greater than " + 
/*  868 */             size() + ", requested " + size);
/*      */       }
/*  870 */       allocateMemory(size);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*  879 */       return new String(this.FileName, 0, this.FileNameLength / 2);
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public void read() {
/*  885 */       this.FileName = new char[0];
/*  886 */       super.read();
/*  887 */       this.FileName = getPointer().getCharArray(12L, this.FileNameLength / 2);
/*      */     }
/*      */     
/*      */     public FILE_NOTIFY_INFORMATION next() {
/*  891 */       if (this.NextEntryOffset == 0) {
/*  892 */         return null;
/*      */       }
/*  894 */       FILE_NOTIFY_INFORMATION next = new FILE_NOTIFY_INFORMATION();
/*  895 */       next.useMemory(getPointer(), this.NextEntryOffset);
/*  896 */       next.read();
/*  897 */       return next;
/*      */     }
/*      */   }
...
/* 1158 */         this(new WinDef.DWORD(value & 0xFFFFFFFFL), new WinDef.DWORD(value >> 32L & 0xFFFFFFFFL));
/*      */       }
/*      */       
/*      */       public LowHigh(WinDef.DWORD low, WinDef.DWORD high) {
/* 1162 */         this.LowPart = low;
/* 1163 */         this.HighPart = high;
/*      */       }
/*      */       
/*      */       public long longValue() {
/* 1167 */         long loValue = this.LowPart.longValue();
/* 1168 */         long hiValue = this.HighPart.longValue();
/* 1169 */         return hiValue << 32L & 0xFFFFFFFF00000000L | loValue & 0xFFFFFFFFL;
/*      */       }
/*      */ 
/*      */       
/*      */       public String toString() {
/* 1174 */         if (this.LowPart == null || this.HighPart == null) {
/* 1175 */           return "null";
/*      */         }
/* 1177 */         return Long.toString(longValue());
/*      */       }
/*      */     }
/*      */ 
/*      */     
...
/* 1192 */         this.lh = new WinNT.LARGE_INTEGER.LowHigh(value);
/*      */       }
/*      */       
/*      */       public long longValue() {
...
/*      */       
/*      */       public String toString() {
/* 1201 */         return Long.toString(longValue());
/*      */       }
/*      */     }
/*      */ 
/*      */ 
...
/* 1230 */       return this.u.lh.HighPart;
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     
/*      */     public String toString() {
/* 1249 */       return (this.u == null) ? "null" : Long.toString(getValue());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1271 */         return -1;
/*      */       }
/* 1273 */       return IntegerType.compare(v1.getValue(), v2.getValue());
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1290 */         return 1;
/*      */       }
/* 1292 */       return IntegerType.compare(v1.getValue(), v2);
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1307 */       setPointer(p);
/* 1308 */       this.immutable = true;
/*      */     }
/*      */ 
/*      */ 
/*      */     
/*      */     public Object fromNative(Object nativeValue, FromNativeContext context) {
/* 1314 */       Object o = super.fromNative(nativeValue, context);
/* 1315 */       if (WinBase.INVALID_HANDLE_VALUE.equals(o)) {
/* 1316 */         return WinBase.INVALID_HANDLE_VALUE;
/*      */       }
/* 1318 */       return o;
/*      */     }
/*      */ 
...
/* 1323 */       if (this.immutable) {
/* 1324 */         throw new UnsupportedOperationException("immutable reference");
/*      */       }
/*      */       
/* 1327 */       super.setPointer(p);
/*      */     }
/*      */ 
/*      */     
/*      */     public String toString() {
/* 1332 */       return String.valueOf(getPointer());
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 1345 */       super(Native.POINTER_SIZE);
/* 1346 */       setValue(h);
/*      */     }
/*      */     
/*      */     public void setValue(WinNT.HANDLE h) {
/* 1350 */       getPointer().setPointer(0L, (h != null) ? h.getPointer() : null);
/*      */     }
/*      */     
/*      */     public WinNT.HANDLE getValue() {
/* 1354 */       Pointer p = getPointer().getPointer(0L);
/* 1355 */       if (p == null) {
/* 1356 */         return null;
/*      */       }
/* 1358 */       if (WinBase.INVALID_HANDLE_VALUE.getPointer().equals(p)) {
/* 1359 */         return WinBase.INVALID_HANDLE_VALUE;
/*      */       }
/* 1361 */       WinNT.HANDLE h = new WinNT.HANDLE();
/* 1362 */       h.setPointer(p);
/* 1363 */       return h;
/*      */     }
/*      */   }
...
/* 1848 */       this.szCSDVersion = new char[128];
/* 1849 */       this.dwOSVersionInfoSize = new WinDef.DWORD(size());
/*      */     }
/*      */     
...
/* 1935 */       this.szCSDVersion = new char[128];
/* 1936 */       this.dwOSVersionInfoSize = new WinDef.DWORD(size());
/*      */     }
/*      */     
...
/*      */     
/*      */     public int getMajor() {
/* 1948 */       return this.dwMajorVersion.intValue();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
/*      */     
/*      */     public int getMinor() {
/* 1955 */       return this.dwMinorVersion.intValue();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1962 */       return this.dwBuildNumber.intValue();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1969 */       return this.dwPlatformId.intValue();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1978 */       return Native.toString(this.szCSDVersion);
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 1985 */       return this.wSuiteMask.intValue();
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 2453 */       this.data = data;
/* 2454 */       useMemory((Pointer)new Memory(data.length));
/*      */     }
/*      */ 
/*      */     
/*      */     public SECURITY_DESCRIPTOR(int size) {
/* 2459 */       useMemory((Pointer)new Memory(size));
/* 2460 */       this.data = new byte[size];
/*      */     }
/*      */     
...
/*      */     extends Structure
/*      */   {
/* 2487 */     public static int MAX_ACL_SIZE = 65536;
/*      */     
...
/*      */     
/*      */     public ACL(int size) {
/* 2501 */       useMemory((Pointer)new Memory(size));
/*      */     }
/*      */     
...
/* 2519 */       WinNT.ACE_HEADER[] ACEs = new WinNT.ACE_HEADER[this.AceCount];
/* 2520 */       Pointer pointer = getPointer();
/* 2521 */       int offset = size();
/* 2522 */       for (int i = 0; i < this.AceCount; i++) {
/* 2523 */         Pointer share = pointer.share(offset);
/* 2524 */         byte aceType = share.getByte(0L);
/* 2525 */         switch (aceType) {
/*      */           case 0:
/* 2527 */             ACEs[i] = new WinNT.ACCESS_ALLOWED_ACE(share);
/*      */             break;
/*      */           case 1:
/* 2530 */             ACEs[i] = new WinNT.ACCESS_DENIED_ACE(share);
/*      */             break;
/*      */           default:
/* 2533 */             ACEs[i] = new WinNT.ACE_HEADER(share);
/*      */             break;
/*      */         } 
/* 2536 */         offset += (ACEs[i]).AceSize;
/*      */       } 
/* 2538 */       return ACEs;
/*      */     }
/*      */   }
...
/* 2548 */       super(Native.POINTER_SIZE);
/* 2549 */       setValue(h);
/*      */     }
/*      */     
/*      */     public void setValue(WinNT.ACL h) {
/* 2553 */       getPointer().setPointer(0L, (h != null) ? h.getPointer() : null);
/*      */     }
/*      */     
/*      */     public WinNT.ACL getValue() {
/* 2557 */       Pointer p = getPointer().getPointer(0L);
/* 2558 */       if (p == null) {
/* 2559 */         return null;
/*      */       }
/*      */       
/* 2562 */       return new WinNT.ACL(p);
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 2591 */       super((Pointer)new Memory(data.length));
/* 2592 */       getPointer().write(0L, data, 0, data.length);
/* 2593 */       setMembers();
/*      */     }
/*      */     
/*      */     public SECURITY_DESCRIPTOR_RELATIVE(int length) {
/* 2597 */       super((Pointer)new Memory(length));
/*      */     }
/*      */     
...
/* 2606 */       return this.OWNER;
/*      */     }
/*      */     
/*      */     public WinNT.PSID getGroup() {
/* 2610 */       return this.GROUP;
/*      */     }
/*      */     
/*      */     public WinNT.ACL getDiscretionaryACL() {
/* 2614 */       return this.DACL;
/*      */     }
/*      */     
/*      */     public WinNT.ACL getSystemACL() {
/* 2618 */       return this.SACL;
/*      */     }
/*      */     
/*      */     private final void setMembers() {
/* 2622 */       read();
/* 2623 */       if (this.Dacl != 0) {
/* 2624 */         this.DACL = new WinNT.ACL(getPointer().share(this.Dacl));
/*      */       }
/* 2626 */       if (this.Sacl != 0) {
/* 2627 */         this.SACL = new WinNT.ACL(getPointer().share(this.Sacl));
/*      */       }
/* 2629 */       if (this.Group != 0) {
/* 2630 */         this.GROUP = new WinNT.PSID(getPointer().share(this.Group));
/*      */       }
/* 2632 */       if (this.Owner != 0) {
/* 2633 */         this.OWNER = new WinNT.PSID(getPointer().share(this.Owner));
/*      */       }
/*      */     }
/*      */   }
/*      */   
...
/* 2655 */       this.AceType = AceType;
/* 2656 */       this.AceFlags = AceFlags;
/* 2657 */       this.AceSize = AceSize;
/* 2658 */       write();
/*      */     }
/*      */   }
/*      */ 
...
/*      */ 
/*      */     
/* 2672 */     public byte[] SidStart = new byte[4];
/*      */ 
/*      */     
/*      */     WinNT.PSID psid;
/*      */ 
...
/* 2682 */       calculateSize(true);
/* 2683 */       this.AceType = AceType;
/* 2684 */       this.AceFlags = AceFlags;
/* 2685 */       this.AceSize = (short)(fieldOffset("SidStart") + (psid.getBytes()).length);
/* 2686 */       this.psid = psid;
/* 2687 */       this.Mask = Mask;
/* 2688 */       this.SidStart = psid.getPointer().getByteArray(0L, this.SidStart.length);
/* 2689 */       allocateMemory(this.AceSize);
/* 2690 */       write();
/*      */     }
/*      */     
...
/*      */     
/*      */     public String getSidString() {
/* 2699 */       return Advapi32Util.convertSidToStringSid(this.psid);
/*      */     }
/*      */     
/*      */     public WinNT.PSID getSID() {
/* 2703 */       return this.psid;
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/*      */     public void write() {
/* 2711 */       super.write();
/* 2712 */       int offsetOfSID = fieldOffset("SidStart");
/* 2713 */       int sizeOfSID = this.AceSize - fieldOffset("SidStart");
/* 2714 */       if (this.psid != null) {
/*      */         
/* 2716 */         byte[] psidWrite = this.psid.getBytes();
/* 2717 */         assert psidWrite.length <= sizeOfSID;
/*      */         
/* 2719 */         getPointer().write(offsetOfSID, psidWrite, 0, sizeOfSID);
/*      */       } 
/*      */     }
/*      */ 
/*      */     
/*      */     public void read() {
/* 2725 */       if (this.SidStart == null) {
/* 2726 */         this.SidStart = new byte[4];
/*      */       }
/* 2728 */       super.read();
/* 2729 */       int offsetOfSID = fieldOffset("SidStart");
/* 2730 */       int sizeOfSID = this.AceSize - fieldOffset("SidStart");
/* 2731 */       if (sizeOfSID > 0) {
/* 2732 */         this.psid = new WinNT.PSID(getPointer().getByteArray(offsetOfSID, sizeOfSID));
/*      */       } else {
/* 2734 */         this.psid = new WinNT.PSID();
/*      */       } 
/*      */     }
/*      */   }
/*      */ 
...
/* 2750 */       super(Mask, (byte)0, AceFlags, psid);
/*      */     }
/*      */   }
/*      */ 
/*      */   
...
/* 2765 */       super(Mask, (byte)1, AceFlags, psid);
/*      */     }
/*      */   }
/*      */ 
/*      */ 
...
/*      */ 
/*      */       
/* 2883 */       public WinDef.ULONGLONG[] reserved = new WinDef.ULONGLONG[2];
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 2982 */       int relationship = memory.getInt(0L);
/*      */       
/* 2984 */       switch (relationship) {
/*      */         case 0:
/*      */         case 3:
/* 2987 */           result = new WinNT.PROCESSOR_RELATIONSHIP(memory);
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */           
/* 3001 */           result.read();
/* 3002 */           return result;case 1: result = new WinNT.NUMA_NODE_RELATIONSHIP(memory); result.read(); return result;case 2: result = new WinNT.CACHE_RELATIONSHIP(memory); result.read(); return result;case 4: result = new WinNT.GROUP_RELATIONSHIP(memory); result.read(); return result;
/*      */       } 
...
/*      */ 
/*      */     
/* 3051 */     public byte[] reserved = new byte[20];
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 3075 */     public WinNT.GROUP_AFFINITY[] groupMask = new WinNT.GROUP_AFFINITY[1];
/*      */ 
/*      */     
...
/*      */     
/*      */     public void read() {
/* 3086 */       readField("groupCount");
/* 3087 */       this.groupMask = new WinNT.GROUP_AFFINITY[this.groupCount];
/* 3088 */       super.read();
/*      */     }
/*      */   }
/*      */ 
...
/*      */ 
/*      */     
/* 3108 */     public byte[] reserved = new byte[20];
/*      */ 
/*      */     
...
/*      */ 
/*      */     
/* 3160 */     public byte[] reserved = new byte[20];
/*      */ 
/*      */     
/*      */     public WinNT.GROUP_AFFINITY groupMask;
/*      */ 
...
/*      */ 
/*      */     
/* 3197 */     public byte[] reserved = new byte[20];
/*      */ 
/*      */ 
/*      */ 
/*      */ 
...
/*      */ 
/*      */     
/* 3205 */     public WinNT.PROCESSOR_GROUP_INFO[] groupInfo = new WinNT.PROCESSOR_GROUP_INFO[1];
/*      */ 
/*      */     
...
/*      */     
/*      */     public void read() {
/* 3216 */       readField("activeGroupCount");
/* 3217 */       this.groupInfo = new WinNT.PROCESSOR_GROUP_INFO[this.activeGroupCount];
/* 3218 */       super.read();
/*      */     }
/*      */   }
/*      */ 
...
/*      */ 
/*      */     
/* 3243 */     public short[] reserved = new short[3];
/*      */     
...
/*      */ 
/*      */     
/* 3273 */     public byte[] reserved = new byte[38];
/*      */ 
/*      */ 
/*      */     
...
/*      */   {
/* 3380 */     public static int CacheUnified = 0;
/*      */ 
/*      */ 
/*      */ 
/*      */     
/* 3385 */     public static int CacheInstruction = 1;
/*      */ 
/*      */ 
/*      */ 
/*      */     
/* 3390 */     public static int CacheData = 2;
/*      */ 
/*      */ 
/*      */ 
/*      */     
/* 3395 */     public static int CacheTrace = 3;
/*      */   }
/*      */ 
/*      */   
...
/* 3437 */     public byte[] Spare1 = new byte[3];
/*      */     public byte Tag;
...
/*      */   {
/*      */     public byte Enable;
/* 3524 */     public byte[] Spare = new byte[3];
/*      */     
...
/* 3551 */     public byte[] Spare2 = new byte[2];
/*      */     public int MinSleep;
/*      */     public int MaxSleep;
...
/* 3559 */     public WinNT.SYSTEM_POWER_LEVEL[] DischargePolicy = new WinNT.SYSTEM_POWER_LEVEL[4];
/*      */     public int VideoTimeout;
/*      */     public byte VideoDimDisplay;
/* 3562 */     public int[] VideoReserved = new int[3];
...
/* 3624 */     public byte[] spare3 = new byte[6];
/*      */     
/*      */     public byte SystemBatteriesPresent;
/*      */     
/*      */     public byte BatteriesAreShortTerm;
/* 3629 */     public WinNT.BATTERY_REPORTING_SCALE[] BatteryScale = new WinNT.BATTERY_REPORTING_SCALE[3];
/*      */     
...
/* 4037 */       return new WinDef.LCID(_MAKELCID(lgid, srtid));
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 4049 */       return new WinDef.LCID((_MAKELCID(lgid, srtid) | ver << 20));
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 4059 */       return lcid.intValue() & 0xFFFF;
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 4069 */       return lcid.intValue() >>> 16 & 0xF;
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 4079 */       return lcid.intValue() >>> 20 & 0xF;
/*      */     }
/*      */ 
/*      */ 
/*      */ 
...
/* 4110 */       return (lgid & 0xFFFF) >>> 10;
/*      */     }
/*      */   }
/*      */   
/* 4114 */   public static final int LANG_SYSTEM_DEFAULT = LocaleMacros.MAKELANGID(0, 2);
/* 4115 */   public static final int LANG_USER_DEFAULT = LocaleMacros.MAKELANGID(0, 1);
/*      */   
/* 4117 */   public static final WinDef.LCID LOCALE_SYSTEM_DEFAULT = LocaleMacros.MAKELCID(LANG_SYSTEM_DEFAULT, 0);
/* 4118 */   public static final WinDef.LCID LOCALE_USER_DEFAULT = LocaleMacros.MAKELCID(LANG_USER_DEFAULT, 0);
/*      */   
/* 4120 */   public static final WinDef.LCID LOCALE_NEUTRAL = LocaleMacros.MAKELCID(LocaleMacros.MAKELANGID(0, 0), 0);
/*      */   
/* 4122 */   public static final WinDef.LCID LOCALE_INVARIANT = LocaleMacros.MAKELCID(LocaleMacros.MAKELANGID(127, 0), 0);
/*      */ 
/*      */ 
/*      */ 
/*      */   
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/com/sun/jna/platform/win32/WinNT.class
