...
/* 198 */       return true;
/*     */     }
/* 200 */     return (Native.POINTER_SIZE == 8);
/*     */   }
/*     */   
/*     */   public static final boolean isIntel() {
/* 204 */     if (ARCH.startsWith("x86")) {
/* 205 */       return true;
/*     */     }
/* 207 */     return false;
/*     */   }
...
/* 218 */     return ARCH.startsWith("arm");
/*     */   }
/*     */   
/*     */   public static final boolean isSPARC() {
/* 222 */     return ARCH.startsWith("sparc");
/*     */   }
/*     */   
/*     */   public static final boolean isMIPS() {
/* 226 */     if (ARCH.equals("mips") || ARCH
/* 227 */       .equals("mips64") || ARCH
/* 228 */       .equals("mipsel") || ARCH
/* 229 */       .equals("mips64el")) {
/* 230 */       return true;
/*     */     }
/* 232 */     return false;
...
/*     */ 
/*     */     
/* 251 */     if ("ppc64".equals(arch) && "little".equals(System.getProperty("sun.cpu.endian"))) {
/* 252 */       arch = "ppc64le";
/*     */     }
/*     */     
/* 255 */     if ("arm".equals(arch) && platform == 1 && isSoftFloat()) {
/* 256 */       arch = "armel";
/*     */     }
/*     */     
/* 259 */     return arch;
...
/*     */     try {
/* 264 */       File self = new File("/proc/self/exe");
/* 265 */       if (self.exists()) {
/* 266 */         ELFAnalyser ahfd = ELFAnalyser.analyse(self.getCanonicalPath());
/* 267 */         return !ahfd.isArmHardFloat();
/*     */       } 
/* 269 */     } catch (IOException ex) {
/*     */       
/* 271 */       Logger.getLogger(Platform.class.getName()).log(Level.INFO, "Failed to read '/proc/self/exe' or the target binary.", ex);
/* 272 */     } catch (SecurityException ex) {
/*     */       
/* 274 */       Logger.getLogger(Platform.class.getName()).log(Level.INFO, "SecurityException while analysing '/proc/self/exe' or the target binary.", ex);
/*     */     } 
/* 276 */     return false;
/*     */   }
/*     */ 
...
/* 283 */     String prefix = System.getProperty("jna.prefix");
/* 284 */     if (prefix != null) {
/* 285 */       return prefix;
/*     */     }
/* 287 */     return getNativeLibraryResourcePrefix(getOSType(), System.getProperty("os.arch"), System.getProperty("os.name"));
/*     */   }
/*     */ 
/*     */ 
/*     */ 
...
/* Location:              /mnt/r/ConTenDoViewer.jar!/com/sun/jna/Platform.class
